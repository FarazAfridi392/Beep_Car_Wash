                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      itemBuilder: (context, index) => GestureDetector(
                        onTap: () {
                          for (int i = 0;
                              i < controller.reportOptionModel.data!.length;
                              i++) {
                            if (index == i) {
                              controller.reportOptionModel.data![i].isSelected =
                                  true;
                              controller.issueId.value = controller
                                      .reportOptionModel.data?[i].id
                                      .toString() ??
                                  "";
                            } else {
                              controller.reportOptionModel.data![i].isSelected =
                        ...
                        child: Row(
                          children: [
                            Icon(
                              controller.reportOptionModel.data?[index]
                                          .isSelected ??
                                      false
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        Get.to(() => const ScanQRCodeScreen(),
                            ...
                            arguments: ["Report", machineId.toString()])?.then(
                          (value) {
                            if (value != null) {
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            Text(
                              controller.machineCode.value.isEmpty
                                  ? Strings.machineCode
                                  : controller.machineCode.value,
                              style: TextStyle(
                                color: AppColors.appColorText,
                                fontWeight: FontWeight.bold,
                                fontSize: 12.sp,
                    ...
                    CustomTextField(
                      ...
                      onChange: (val) {
                        controller.comment.text = val;
                        controller.comment.selection = TextSelection(
                            baseOffset: controller.comment.text.length,
                            extentOffset: controller.comment.text.length);
                      },
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Divider(height: 0.8.h),
              SizedBox(
                  height: MediaQuery.of(Get.context!).padding.bottom + 1.6.h),
            ],
          ),
        ),
      ],
