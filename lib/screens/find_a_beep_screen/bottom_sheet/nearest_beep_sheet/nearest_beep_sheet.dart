      ...
      builder: Builder(
        builder: (context) => GetBuilder<NearestBeepController>(
          initState: (state) {
            ...
            if (Get.find<CommonController>().getStorageData.readString(
                    Get.find<CommonController>().getStorageData.isFirst) ==
                "1") {
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                            ...
                            Obx(() {
                              return AnimatedContainer(
                                ...
                                margin: EdgeInsets.symmetric(
                                    vertical: controller.isExpand.value == 2
                                        ? 1.5.h
                                        : 0),
                                height: controller.isExpand.value == 1
                                    ...
                                    : controller.isExpand.value == 2
                                        ? 20.h
                                        : 0,
                                child: controller.isExpand.value == 1 ||
                                        controller.isExpand.value == 2
                                    ? Row(
                                        children: [
                                          controller.isExpand.value == 2
                                                ...
                                                children: [
                                                  Image.asset(
                                                    controller
                                                        .machineData[index]
                                                        .image!,
                                                    height: controller.isExpand
                                                                .value ==
                                                            1
                                                        ? 3.h
                                                        : 3.6.h,
                                                    width: controller.isExpand
                                                                .value ==
                                                            1
                                                        ? 3.h
                                                        : 3.6.h,
                          ...
                          children: controller.actionList
                              .map((e) => GestureDetector(
                                    onTap: () async {
                                      if (e.index! == 0) {
                                        launchUrl(
                                            controller.createCoordinatesUri(
                                                machineData!.lat!,
                                                machineData!.long!,
                                                "Beep Car wash"));
                                      } else if (e.index == 1) {
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Column(
                                        children: [
                                          Showcase(
                                            key: controller
                                                .showCaseKeyList[e.index!],
                                            description: controller
                                                .showCaseDesList[e.index!],
                                            targetPadding: EdgeInsets.all(1.h),
                                            targetShapeBorder:
                                                const CircleBorder(),
                                            child: machineData!.machineInUse ==
                                                        1 &&
                                                    e.index == 2
                                                ? machineData!.isFareFixed ==
                                                        "0"
                                                    ? Container(
                                                        width: 6.6.h,
                                                        height: 6.6.h,
                      ...
                      SizedBox(
                          height:
                              MediaQuery.of(context).padding.bottom + 1.6.h),
                    ],
                  ),
                ),
              ],
