                          ...
                          onMapCreated:
                            ...
                            controller.mapController!.setMapStyle(
                                await DefaultAssetBundle.of(context).loadString(
                                    'assets/json_file/map_style.json'));
                          },
                        )
                      ...
                      GestureDetector(
                        onTap: () async {
                          await Geolocator.getCurrentPosition(
                            ...
                            Get.find<FindABeepController>().mapView.value =
                                true;
                            Get.find<FindABeepController>()
                                .setMyLocationMarker();
                            Get.find<FindABeepController>()
                                .getMachineAPI(Constants.getMachines);
                          }).catchError((e) {
                            printError(info: e);
                          });
                  ...
                  Column(
                    children: [
                      CustomContainer(
                        ...
                        borderRadius: 1.h,
                        padding: EdgeInsets.only(
                            left: 1.6.h, top: 0.8.h, bottom: 0.8.h),
                        child: Column(
                                          ...
                                          onTap: () {
                                            ...
                                            controller.searchController.text =
                                                controller.predictions[index]
                                                    .description!;
                                            MapService.getLatLngFromAddress(
                                                address: controller
                                                    .predictions[index]
                                                    .description!);
                                            controller.update();
